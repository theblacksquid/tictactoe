...
(function() {
  var Cell, Grid, Row, Start, didPlayerWin, evalGame, flatten, game, getCurrentState, getX, getY, lineFromGrid, menu, o_path, pointsEq, slope, x_path;
  ...
  Start = (function() {
    ...
    Start.prototype.template = function() {
    ...
    Start.prototype.onStart = function() {
      return $("#menu-btn").click(function() {
        if ($("#menu-val").val() < 3) {
          return $("#status").html("Tic Tac Toe | A minimum of three rows are required");
        } else {
